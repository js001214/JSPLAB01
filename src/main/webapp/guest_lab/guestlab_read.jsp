...
<body>
	...
	<%
		...
		//Get 방식으로 넘어오는 변수
		//String 방식으로 모두 넘어 온다. Integer.ParsenInt();로 바꿔준다.
		int idx = Integer.parseInt(request.getParameter("idx"));
		
		/*Statment 객체를 사용해서 처리
		...
		*/
		...
		pstmt.setInt(1, idx);		//1 첫번째 물음표, 들어갈 변수
	...
	<table width='600' cellspacing='0' cellpadding='2' align='center'>
			   ...
			   <div align='left'><br>
			   <font size='3' color='#333333'> <pre><%= rs.getString("address") %></pre>  </div>
			   <br>
			   </td>
			   </tr>
			   <tr align='center'>
   ...
   <table width="600" border="0" cellpadding="0" cellspacing="5">
	<tr> 
		...
		<td width="70" align="right"><A href="guestlab_write.jsp?idx=<%= request.getParameter("idx") %>&page=<%= request.getParameter("page") %>"><img src="image/reply.jpg" border=0></A></td>
